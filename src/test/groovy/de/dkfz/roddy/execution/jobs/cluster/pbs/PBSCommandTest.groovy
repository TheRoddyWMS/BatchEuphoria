...
class PBSCommandTest {
    ...
    void testAssembleVariableExportString() throws Exception {
        ...
        BEJob job = new BEJob("Test", new File("/tmp/test.sh"),null, null, new ResourceSet(ResourceSetSize.l, new BufferValue(1, BufferUnit.G), 4, 1, Duration.ofHours(1), null, null, null), null, mapOfParameters, null, null, null)
