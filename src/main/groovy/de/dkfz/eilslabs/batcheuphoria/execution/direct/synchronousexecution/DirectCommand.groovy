...
//
//import de.dkfz.eilslabs.batcheuphoria.config.AppConfig
...
//        }
//
//        parameterBuilder << WHITESPACE << PARM_WRAPPED_SCRIPT << command;
//
//        //TODO Log handling
//
//        //TODO Array handling
...
//        commandString << parameterBuilder.toString() << WHITESPACE << configuration.getProcessingToolPath(executionContext, "wrapinScript").getAbsolutePath();
//
