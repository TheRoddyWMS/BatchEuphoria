...
public class JobResult implements Serializable {
    ...
    public JobResult(Command command, JobDependencyID jobID, boolean wasExecuted, File toolID, Map<String, String> jobParameters, List<Job> parentFiles) {
        this(command, jobID, wasExecuted, false, toolID, jobParameters, parentFiles);
    }

    public JobResult(Command command, JobDependencyID jobID, boolean wasExecuted, boolean wasArray, File toolID, Map<String, String> jobParameters, List<Job> parentFiles) {
    ...
    public List<Job> getParentFiles() {
        return parentFiles;
    }
}
