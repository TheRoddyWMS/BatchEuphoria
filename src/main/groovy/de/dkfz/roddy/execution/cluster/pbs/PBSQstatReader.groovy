...
"""
    ...
    static Map<String, Map<String, String>> conv(String qstatOutput) {
    ...
    public static void main(String[] args) {
        println "##############################"
        println conv(output1)
        println "##############################"
        println conv(output2)
        TestExecutionService executionService = new TestExecutionService("", "")
        PBSJobManager jobManager = new PBSJobManager(executionService,
        ...
        Map<String, GenericJobInfo> genericJobInfoMap = jobManager.queryJobState([output1])

        //Map<String, Map<String, String>> qstatReaderResult = PBSQstatReader.conv(output1)
        genericJobInfoMap.each { Entry<String,GenericJobInfo> it ->
