...
public class DirectSynchronousExecutionJobManager extends BatchEuphoriaJobManager<DirectCommand> {
    ...
    @Override
    public JobDependencyID createJobDependencyID(BEJob job, String jobResult) {
...
//    }
    ...
    @Override
    public Map<BEJob, GenericJobInfo> queryExtendedJobState(List<BEJob> jobs, boolean forceUpdate) {
        return null;
    }
}
