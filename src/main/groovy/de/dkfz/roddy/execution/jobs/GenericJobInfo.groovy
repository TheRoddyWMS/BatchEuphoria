...
class GenericJobInfo {
    ...
    /** The date-time the job became eligible to run when all conditions like job dependencies
     *  are met, i.e. in a queued state while residing in an execution queue. */
