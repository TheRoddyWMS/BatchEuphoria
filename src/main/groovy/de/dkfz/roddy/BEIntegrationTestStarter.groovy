...
class BEIntegrationTestStarter {
    ...
    private static void singleJobTest(BatchEuphoriaJobManager jobManager, BEJob testJob) {
        ...
        try {
            ...
            ensureProperJobStates(maxSleep, jobList, [JobState.ABORTED, JobState.COMPLETED_UNKNOWN, JobState.COMPLETED_UNKNOWN], jobManager)
    ...
    private static void multipleJobsTest(BatchEuphoriaJobManager jobManager, List<BEJob> testJobs) {
        ...
        try {
            ...
            ensureProperJobStates(maxSleep, testJobs, [JobState.ABORTED, JobState.COMPLETED_UNKNOWN, JobState.COMPLETED_UNKNOWN], jobManager)
